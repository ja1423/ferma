...
export class VaccationHistoryController {
  constructor(private readonly vaccationHistoryService: VaccationHistoryService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateVaccationHistoryDto: UpdateVaccationHistoryDto) {
